...
# https://gist.github.com/leoloobeek/3be8b835988e8d926a4387019370db8d?permalink_comment_id=3780217#gistcomment-3780217
# Add Windows support
...
def download(gist):
    ...
    with open(description_file, "w", encoding="utf-8_sig") as f:
